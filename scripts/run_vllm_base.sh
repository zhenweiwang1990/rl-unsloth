...
echo "=========================================="
echo "vLLM Inference Server - Base Model"
echo "=========================================="
echo ""
...
CONTAINER_NAME="${CONTAINER_NAME:-vllm-base-server}"
...
if [ "$1" = "-h" ] || [ "$1" = "--help" ]; then
    ...
    echo "  CONTAINER_NAME      - Docker container name (default: vllm-base-server)"
    echo ""
    echo "Examples:"
    ...
    echo ""
    echo "  # Run with different base model"
    echo "  BASE_MODEL=meta-llama/Llama-3.1-8B-Instruct ./scripts/run_vllm_base.sh"
    echo ""
    exit 0
fi
